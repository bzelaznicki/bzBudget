					...
					<div className="px-4 lg:px-6">
						<div className="rounded-2xl border border-border bg-card px-6 py-8 shadow-sm">
							<div className="flex flex-wrap items-center gap-3">
								<Badge variant="secondary" className="bg-income/10 text-income-foreground">
									Live account
								</Badge>
								<span className="flex items-center gap-2 text-sm text-muted-foreground">
									<LockKeyhole className="h-4 w-4 text-income-foreground" />
									Secure password update
								</span>
							</div>
							<h1 className="mt-4 text-3xl font-semibold text-foreground">Change your password</h1>
							<p className="mt-2 max-w-2xl text-sm text-muted-foreground">
								We recommend rotating passwords every few months, especially after receiving a
								security alert or sharing a device. Follow the steps below and we&apos;ll guide you
								through a safe update.
							</p>
						</div>
								...
								<Card className="border border-border shadow-sm">
									<CardHeader>
										...
										<CardDescription className="text-sm text-muted-foreground">
											Provide your current password and a new secure password. We&apos;ll take care
											of the rest.
										</CardDescription>
									</CardHeader>
									<CardContent>
								...
								<Card className="border border-border shadow-sm">
									...
									<CardContent className="space-y-4 text-sm text-muted-foreground">
										<div>
											...
											<p>
												We send a quick summary to your inbox so you have a record of the change.
											</p>
										</div>
										<Separator />
										<div>
											<p className="font-medium text-foreground">Session refresh</p>
											<p>
												If you chose to sign out of other sessions, they will be revoked within a
												minute while this tab stays active.
											</p>
										</div>
										<Separator />
										<div>
											<p className="font-medium text-foreground">Need to roll back?</p>
											<p>
												If something looks wrong, reach out to support within 15 minutes and we can
												help restore access.
											</p>
										</div>
									</CardContent>
									...
									<CardContent className="space-y-4 text-sm text-muted-foreground">
										{passwordRequirements.map((requirement) => (
											<div
												...
												className="rounded-lg border border-border bg-sunk p-3"
											>
								...
								<Card className="border border-border shadow-sm">
									...
									<CardContent className="space-y-4">
										{securityReminders.map((reminder) => (
											...
											>
												<div className="rounded-lg bg-income/10 p-2 text-income-foreground">
