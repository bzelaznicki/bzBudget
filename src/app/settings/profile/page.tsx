							...
							<CardContent className="grid gap-4">
								...
								<div className="rounded-xl bg-gray-50 p-4">
									...
									<p className="mt-1 text-xs text-gray-500">
										Review active logins for your account. Revoke any sessions you do not recognise
					...
					<aside className="space-y-6">
						<Card className="border border-gray-100 shadow-sm">
							...
							<CardContent className="space-y-4 text-sm text-gray-600">
								<p>
									Once account linking is enabled, you’ll be able to see and disconnect services
									from this panel.
								</p>
								<div className="rounded-lg border border-dashed border-gray-200 p-3 text-center text-xs text-gray-400">
						...
						<Card className="border border-gray-100 shadow-sm">
							...
							<CardContent className="space-y-3">
								<p className="text-xs text-gray-500">
									Account deletion removes personal data and disconnects any linked services. You
									can restore your account by signing back in before the recovery period ends.
								</p>
