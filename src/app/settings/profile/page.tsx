        ...
        <header className="flex flex-col gap-4 rounded-2xl bg-white px-6 py-8 shadow-sm sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-gray-500">
              Update your profile details, review active connections, and keep
              your security preferences in sync.
            </p>
          </div>
          <Link
            href="/dashboard"
            ...
            <Card className="border border-gray-100 shadow-sm">
              <CardHeader>
                ...
                <CardDescription className="text-sm text-gray-500">
                  Share a name and contact so teammates and notifications know
                  where to reach you.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form className="grid gap-4">
                  ...
                  <div className="flex flex-col gap-3 rounded-xl border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-xs text-emerald-700 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      <p className="font-semibold tracking-wide text-emerald-800">
                        Account status
                      </p>
                      <p>
                        {user.emailVerified
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="rounded-xl bg-gray-50 p-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Review active logins for your account. Revoke any sessions
                    you do not recognise to keep things secure.
                  </p>
                    ...
                    {activeSessions.length === 0 ? (
                      ...
                      activeSessions.map((sessionItem) => {
                        const isCurrentSession =
                          sessionItem.token === currentToken;
                        return (
                          <div
                          ...
                          >
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                ...
                                <p className="text-xs text-gray-500">
                                  IP address:{" "}
                                  {sessionItem.ipAddress ?? "Not available"}
                                </p>
                              </div>
                              {isCurrentSession ? (
                            ...
                            <div className="mt-2 space-y-1 text-xs text-gray-500">
                              ...
                              <p>
                                Last activity:{" "}
                                {formatDateTime(sessionItem.updatedAt)}
                              </p>
                              <p>
          ...
          <aside className="space-y-6">
            <Card className="border border-gray-100 shadow-sm">
              ...
              <CardContent className="space-y-4 text-sm text-gray-600">
                <p>
                  Once account linking is enabled, you’ll be able to see and
                  disconnect services from this panel.
                </p>
                <div className="rounded-lg border border-dashed border-gray-200 p-3 text-center text-xs text-gray-400">
            ...
            <Card className="border border-gray-100 shadow-sm">
              <CardHeader>
                ...
                <CardDescription className="text-sm text-gray-500">
                  Need to deactivate your account? You&rsquo;ll be able to undo
                  this for 30 days.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="text-xs text-gray-500">
                  Account deletion removes personal data and disconnects any
                  linked services. You can restore your account by signing back
                  in before the recovery period ends.
                </p>
